...
public class NodoEliminar {
    ...
    public void eliminar(){
        Nodo eliminar = new Nodo(); //creamos un nuevo nodo
        eliminar = fin.sig; //aqui va a sustituir un nodo vacio por el ultimo
        fin = eliminar; //aqui se hace la sustitucion del nodo para mostrar en pantalla
    }
